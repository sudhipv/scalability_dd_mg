...
*Comparison of scalability of two-grid restricted additive Schwarz variants for the linear heat equation. Left: Strong numerical scalability. Right: Strong parallel scalability *
